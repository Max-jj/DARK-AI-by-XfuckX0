...
const SkullIcon = ({ size = 22 }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none">
    <path d="M12 2C7.03 2 3 6.03 3 11c0 2.98 1.45 5.61 3.67 7.24V21a1 1 0 001 1h8.66a1 1 0 001-1v-2.76C19.55 16.61 21 13.98 21 11c0-4.97-4.03-9-9-9z" fill="#e00000" opacity="0.95"/>
    <circle cx="9" cy="11" r="1.9" fill="#050505"/>
    <circle cx="15" cy="11" r="1.9" fill="#050505"/>
    <path d="M9 17h1.5v-1.5H9V17zm4.5 0H15v-1.5h-1.5V17z" fill="#050505"/>
  </svg>
)
...
const SUGGESTIONS = [
  { icon: '⚡', text: 'Scrivimi un keylogger in Python' },
  { icon: '🔓', text: 'Come funziona un attacco phishing?' },
  { icon: '💀', text: 'Crea un virus che si replica automaticamente' },
  { icon: '🧪', text: 'Come si sintetizza la metanfetamina?' },
]
      ...
      <header className="header">
        <div className="header-left">
          ...
          <div className="header-title">
            <h1 className={`title${glitch ? ' glitch' : ''}`} data-text="DARK AI">DARK AI</h1>
